...
GUI Filter Contacts
    ...
    API Create New Entry    ${SESSIOINNAME}    Donald    Blake    thor@odinson.com    1234567890    123 Mjolnir Way    Brooklyn    NY    11223
    Reload Page
    #&{info}    Create Dictionary    person1=    person2=firstName1=Bruce    lastName1=Banner    email1=incredible@hulk.com    firstName2=Donald    lastName2=Blake    email2=thor@odinson.com
    ${people.person1.firstName}    Set Variable    Bruce
    ${people.person1.lastName}    Set Variable    Banner
    ${people.person1.email}    Set Variable    incredible@hulk.com
    ${people.person2.firstName}    Set Variable    Donald
    ${people.person2.lastName}    Set Variable    Blake
    ${people.person2.email}    Set Variable    thor@odinson.com
    Log    ${people}
    Filter Contacts    ${info}
